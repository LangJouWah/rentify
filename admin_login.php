...
<head>
    ...
    <title>Admin Log In - Rentify</title>
...
<body class="bg-gray-800 font-sans">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-gray-900 p-8 rounded-lg border border-gray-700 w-full max-w-md">
            <h2 class="text-2xl font-bold mb-6 text-center text-gray-100">Admin Log In</h2>
            <form action="admin_login_process.php" method="POST" onsubmit="return validateForm()">
                ...
                <button type="submit" class="w-full bg-indigo-600 text-white p-3 rounded-lg hover:bg-indigo-700 transition">Log In</button>
            </form>
            <p class="mt-4 text-center text-gray-100">Don't have an account? <a href="admin_signup.php" class="text-teal-400 hover:underline">Sign Up</a></p>
        </div>
    </div>
</body>
</html>